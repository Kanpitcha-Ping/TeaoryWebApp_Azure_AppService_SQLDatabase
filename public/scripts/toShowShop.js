function Function1() {
    ...
    if (close1.style.display === "none") {
      ...
      check1Text.innerHTML = "About this item";
      more1Text.style.display = "none";
    } else {
      close1.style.display = "none";
      check1Text.innerHTML = "Close";
...
function Function2() {
    ...
    if (close2.style.display === "none") {
      ...
      check2Text.innerHTML = "About this item";
      more2Text.style.display = "none";
    } else {
      close2.style.display = "none";
      check2Text.innerHTML = "Close";
...
function Function3() {
    ...
    if (close3.style.display === "none") {
      ...
      check3Text.innerHTML = "About this item";
      more3Text.style.display = "none";
    } else {
      close3.style.display = "none";
      check3Text.innerHTML = "Close";
...
function Function4() {
    ...
    if (close4.style.display === "none") {
      ...
      check4Text.innerHTML = "About this item";
      more4Text.style.display = "none";
    } else {
      close4.style.display = "none";
      check4Text.innerHTML = "Close";
...
function Function5() {
    ...
    if (close5.style.display === "none") {
      ...
      check5Text.innerHTML = "About this item";
      more5Text.style.display = "none";
    } else {
      close5.style.display = "none";
      check5Text.innerHTML = "Close";
...
function Function6() {
    ...
    if (close6.style.display === "none") {
      ...
      check6Text.innerHTML = "About this item";
      more6Text.style.display = "none";
    } else {
      close6.style.display = "none";
      check6Text.innerHTML = "Close";
...
function Function7() {
    ...
    if (close7.style.display === "none") {
      ...
      check7Text.innerHTML = "About this item";
      more7Text.style.display = "none";
    } else {
      close7.style.display = "none";
      check7Text.innerHTML = "Close";
...
function Function8() {
    ...
    if (close8.style.display === "none") {
      ...
      check8Text.innerHTML = "About this item";
      more8Text.style.display = "none";
    } else {
      close8.style.display = "none";
      check8Text.innerHTML = "Close";
...
function f1() {
    ...
    if (hide1.style.display === "none") {
      ...
      show1Text.innerHTML = "About this item";
...
function f3() {
    ...
    if (hide3.style.display === "none") {
      ...
      show3Text.innerHTML = "About this item";
